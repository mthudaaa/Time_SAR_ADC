...
C {devices/lab_wire.sym} 590 -500 0 1 {name=p1 sig_type=std_logic lab=vdd}
C {devices/lab_wire.sym} 590 -430 0 1 {name=p2 sig_type=std_logic lab=vss}
...
C {devices/ipin.sym} 330 -590 0 0 {name=p5 lab=vdd}
C {devices/ipin.sym} 330 -560 0 0 {name=p6 lab=swp}
C {devices/ipin.sym} 330 -530 0 0 {name=p7 lab=swn}
C {devices/ipin.sym} 330 -500 0 0 {name=p8 lab=vss}
